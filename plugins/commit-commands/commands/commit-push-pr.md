...
<!-- Modified by ZaunEkko from Anthropic's official commit-commands/commands/commit-push-pr.md. This distribution routes commit creation through a compact dynamic model-attribution wrapper and enforces dependent Git steps sequentially. -->
