...
| プラグイン | 状態 | 説明 | ドキュメント |
|---|---|---|---|
| `commit-commands` | 利用可能・互換配布 | 公式の 3 コマンド名を維持し、現在のセッションモデルと任意の effort を Git commit attribution に書き込みます。 | [利用ガイド](docs/commit-commands/README.md) · [実装とアップストリーム情報](../../plugins/commit-commands/README.md) |
