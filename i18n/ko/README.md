...
| 플러그인 | 상태 | 설명 | 문서 |
|---|---|---|---|
| `commit-commands` | 사용 가능 · 호환 배포 | 공식 3개 명령 이름을 유지하고 현재 세션 모델과 선택적 effort를 Git commit attribution에 기록합니다. | [사용 가이드](docs/commit-commands/README.md) · [구현 및 업스트림 정보](../../plugins/commit-commands/README.md) |
